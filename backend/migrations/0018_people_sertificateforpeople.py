# Generated by Django 4.2.5 on 2024-04-08 10:00
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('backend', '0017_alter_quote_options'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(blank=True, max_length=255, null=True, verbose_name='Почта')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('news', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SertificateForPeople', to='backend.people')),
            ],
        ),
    ]
